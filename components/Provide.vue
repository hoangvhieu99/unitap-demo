    ...
    <div class="grid grid-cols-2">
      ...
      <div class="mt-28 ">
        <h2 class="text-tt font-bold text-secondry">
          UNITAP CUNG CẤP GÌ CHO BẠN?
        </h2>
        <div class="text-pv font-medium text-provide pt-7 max-w-xl mb-14">
          Unitap cung cấp cho bạn thẻ chạm vào điện thoại để chia sẻ thông tin,
          giảm<br />
          thời gian trao đổi các mạng xã hội như Facebook, Instagram, Zalo, Số
          điện<br />
          thoại, Email và thông tin liên lạc
        </div>
